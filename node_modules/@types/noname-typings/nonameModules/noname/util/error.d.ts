export class CodeSnippet {
    ...
    static #snippetStack: Array<CodeSnippet>;
    /**
     * ```plain
     * 获取当前代码片段
     * ```
...
export class ErrorReporter {
    static #topAlert: any;
    static #errorLineNoPatterns: RegExp[];
    static #findLineNo: (line: any) => number;
    /**
     * ```plain
     * 向用户报告错误信息
     * ```
...
export class ErrorManager {
    ...
    static #codeSnippets: WeakMap<Function, CodeSnippet>;
    /** @type {WeakMap<Object, ErrorReporter>} */
    static #errorReporters: WeakMap<any, ErrorReporter>;
    /**
     * ```plain
     * 获取函数对应的代码片段
     * ```
