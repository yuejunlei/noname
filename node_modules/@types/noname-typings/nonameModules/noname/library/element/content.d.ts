export namespace Content {
    ...
    function _save(): void;
    function chooseNumbers(event: any, trigger: any, player: any): Promise<void>;
     ...
     * @param {Player} player
     */
    function chooseToMove(event: GameEvent, trigger: GameEvent, player: Player): Promise<void>;
    ...
    function phaseLoop(event: any, trigger: any, player: any): Promise<never>;
    ...
    let chooseToDiscard: ((event: any, trigger: any, player: any) => Promise<void>)[];
    ...
    let chooseToCompare: ((event: any, trigger: any, player: any, result: any) => Promise<void>)[];
    function chooseToCompareEffect(event: any, trigger: any, player: any): Promise<void>;
    ...
    let chooseButtonTarget: ((event: any, _trigger: any, player: any, result: any) => Promise<void>)[];
    function chooseControl(): void;
    function chooseBool(): void;
    function chooseDrawRecover(event: any, trigger: any, player: any): Promise<void>;
    ...
    let gain: ((event: any, trigger: any, player: any) => Promise<void>)[];
    function addToExpansion(): void;
    let lose: ((event: any, trigger: any, player: any) => Promise<void>)[];
    ...
    function dying(): void;
    function die(): void;
    function revive(event: any, trigger: any, player: any): Promise<void>;
